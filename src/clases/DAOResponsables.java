...
public class DAOResponsables extends Responsables {
    ...
    public boolean agregar() {
        ...
        try {
            ...
            pstm.setString(5, super.getTel1());
    ...
    public boolean eliminar() {
        ...
        con = Conex.getInstance().getConnection();
        try {
            CallableStatement pstm = con.prepareCall("call del_Responsable(?)");
    ...
    public boolean buscar() {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                super.setTel1(rs.getString("Tel"));
...
//<editor-fold defaultstate="collapsed" desc="FiltrarResponsable">
    ...
    public boolean modificar() {
        ...
        try {
            ...
            pstm.setString(6, super.getTel1());
