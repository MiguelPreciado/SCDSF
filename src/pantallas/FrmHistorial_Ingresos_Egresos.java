...
//    }
    ...
    private void initComponents() {
        ...
        tblHistorial.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "PACIENTE", "NoExpediente", "Autoziado"
            }
        ) {
        ...
        btnListarEgresos.setText("Listar Egresos del Paciente");
        btnListarEgresos.setMaximumSize(new java.awt.Dimension(101, 23));
        ...
        btnListarIngresos.setText("Listar ingresos del Paciente");
        btnListarIngresos.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        ...
        btnListasMovimientos.setText("Listar todos los movimientos del Paciente");
        btnListasMovimientos.setMaximumSize(new java.awt.Dimension(101, 23));
        ...
        txtNoExpediente.setEditable(false);
        txtNoExpediente.setBackground(new java.awt.Color(204, 204, 204));
            ...
            .addGroup(pnlDatos2Layout.createSequentialGroup()
                .addGroup(pnlDatos2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pnlDatos2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtAutorizado, javax.swing.GroupLayout.PREFERRED_SIZE, 240, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(pnlDatos2Layout.createSequentialGroup()
                    ...
                    .addGroup(pnlDatos2Layout.createSequentialGroup()
                        .addComponent(txtFiltroPacientes, javax.swing.GroupLayout.PREFERRED_SIZE, 146, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(cmbFiltradoPacientes, javax.swing.GroupLayout.PREFERRED_SIZE, 159, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    ...
                    .addGroup(pnlDatos2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(btnListarEgresos, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(btnListasMovimientos, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 312, Short.MAX_VALUE))
                    .addGroup(pnlDatos2Layout.createSequentialGroup()
                        .addContainerGap()
                        .addGroup(pnlDatos2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(pnlDatos2Layout.createSequentialGroup()
    ...
    private void btnReingresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReingresarActionPerformed
        DAOPacientes dp = new DAOPacientes();
        if (!txtAutorizado.getText().isEmpty()){ 
            if (!txtNoExpediente.getText().isEmpty()) {
                ...
                if(dp.buscarActivacion()==false){
                    ...
                    JOptionPane.showMessageDialog(rootPane, "ERROR: El paciente no puede reingresar, ya que este no a egresado.");
                }
            }else{
                JOptionPane.showMessageDialog(this, "ERROR: Faltó el No. de expediente.");
            }
        }else{
            JOptionPane.showMessageDialog(this, "ERROR: Faltó el quien autorize el reingreso.");
        }
        ...
        if (!txtAutorizado.getText().isEmpty()){ 
            if (!txtNoExpediente.getText().isEmpty()) {
                ...
                if(dp.buscarActivacion()==true){
                    ...
                    JOptionPane.showMessageDialog(rootPane, "ERROR: El paciente no puede egresar de nuevo, ya que este no a reingresado.");
                }
            } else {
                JOptionPane.showMessageDialog(this, "ERROR: Faltó el No. de expediente.");
            }
        }else{
            JOptionPane.showMessageDialog(this, "ERROR: Faltó el quien autorize el egreso.");
        }
