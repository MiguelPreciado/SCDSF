...
public class frmProducto extends javax.swing.JFrame {
    ...
    private void txtNombreProductoPatActionPerformed(java.awt.event.ActionEvent evt) {                                                     
        // TODO add your handling code here:
    }                                                    

    private void txtContenidoCajaActionPerformed(java.awt.event.ActionEvent evt) {                                                 
        // TODO add your handling code here:
    }                                                
                    ...
                    if (cmbAdministracion.getItemCount() != 0) {
                        if (cmbTipoProducto.getItemCount() != 0) {
                            ...
                            if ((dp1.agregar())) {
                                ...
                                JOptionPane.showMessageDialog(rootPane, "No se agrego el producto. El producto ya existe");
                            }
                        } else {
    ...
    private void btnAgregarAdministracionActionPerformed(java.awt.event.ActionEvent evt) {                                                         
        this.setVisible(false);
        frmAdministracion adm = new frmAdministracion();
        adm.setVisible(true);
    }                                                        

    private void btnTipoActionPerformed(java.awt.event.ActionEvent evt) {                                        
        this.setVisible(false);
...
//                      cmbAdministracion.
    ...
    private void txtNombreProductoGenActionPerformed(java.awt.event.ActionEvent evt) {                                                     
        // TODO add your handling code here:
    }                                                    

    private void btnListarParecidosActionPerformed(java.awt.event.ActionEvent evt) {                                                   
    ...
    private void txtNombreProductoPatKeyReleased(java.awt.event.KeyEvent evt) {                                                 
        txtNombreProductoPat.setText(txtNombreProductoPat.getText().toUpperCase());
    }                                                

    private void txtNombreProductoGenKeyTyped(java.awt.event.KeyEvent evt) {                                              

    }                                             

    private void txtNombreProductoGenKeyReleased(java.awt.event.KeyEvent evt) {                                                 
        txtNombreProductoGen.setText(txtNombreProductoGen.getText().toUpperCase());
    }                                                

    private void txtContenidoCajaKeyReleased(java.awt.event.KeyEvent evt) {                                             
        txtContenidoCaja.setText(txtContenidoCaja.getText().toUpperCase());
    }                                            

    private void txtStockActualKeyReleased(java.awt.event.KeyEvent evt) {                                           
        // TODO add your handling code here:
    }                                          
